...
Mapping are available as polygons for use in geospatial analysis
...
-   Tree and vegetation influence the local temperatures
...
-   Satellites record reflected light in differ regions of the light spectrum (wavelengths)

-   Data = a value of intensity for average over wavelength "band"
...
-   Leverages the ability of clients requesting just the parts of a file they need. (https://cogeo.org)
